...
class Tasks (ContainerTab):

    meta_type = 'Maintenance Tasks'
    ...
    def all_meta_types(self):
        return (
            {'name': 'MaintenanceTask',
             'action': 'manage_addProduct/PloneMaintenance/manage_addContentForm',
             'permission': ManagePortal },)


InitializeClass(Tasks)
